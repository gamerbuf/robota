...
<html> 
    ...
    <p align="top left"> <img src="dom1.png" width="250" alt="растущие лилии" border="2"> Полный контроль над домом даже на расстоянии — можно выключить свет, проверить камеры, закрыть дверь или отключить утюг с телефона.
Автоматизация рутины — свет сам включается вечером, шторы открываются утром, кондиционер подстраивается под температуру. 
        
        <p style="text-align: right;">
    <img src="dom2.png" width="250" alt="фиолетовые" border="2" style="display: block; margin-left: auto;">
  ...
  <p>  <img src="Группа 1.png" width="250" alt="фиолетовые" border="2" style="vertical-align: middle; margin-left: 10px;">  Надёжность умного дома
...
<p align="top left"> <img src="Группа 2.png" width="250" alt="фиолетовые" border="2" style="display: block; margin-left: auto;"> Экологическая результативность умного дома
...
<tr>
             <td align="center">
                <font face="Arial" size="10" color="#ffffff">Пример работы:</font>
